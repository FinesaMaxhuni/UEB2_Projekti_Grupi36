        ...
        <div class="container">
            ...
            <div class="product-grid">
                ...
                <div class="product-item">
                    ...
                    <img
                        src="<?php echo htmlspecialchars($laptop['image']); ?>"
                        alt="<?php echo htmlspecialchars($laptop['product_name']); ?>"
                    >
                    ...
                    <a
                        href="pages/pagesa.php?id=<?php echo $laptop['id']; ?>"
