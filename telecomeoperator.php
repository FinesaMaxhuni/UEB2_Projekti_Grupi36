...
<section class="offers"><div class="container">
  ...
  </div><div class="carousel-dots"><button class="dot active" data-slide="0"></button><button class="dot" data-slide="1"></button></div></div>
</div></section>
...
<section class="netwave-ad"><div class="ad-banner-full"><div class="container"><div class="ad-banner">
  <div class="ad-content">
    <h3>eSIM nga NetWave</h3><p>Aktivizo online dhe merr internet menjëherë</p>
...
<section id="rreth" class="about"><div class="container">
  ...
  <div class="about-content">
    <div class="about-values">
      <div class="value-card"><div class="value-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg></div><h3>Shpejtësi e Lartë</h3><p>Rrjet fiber optik me shpejtësi deri në 1Gbps për eksperiencë të paprecedentë</p></div>
      <div class="value-card"><div class="value-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg></div><h3>Mbështetje 24/7</h3><p>Ekipi ynë i dedikuar është gjithmonë i gatshëm t'ju ndihmojë në çdo moment</p></div>
      <div class="value-card"><div class="value-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg></div><h3>Instalim i Shpejtë</h3><p>Aktivizimi i shërbimeve brenda 24-48 orëve nga momenti i aplikimit</p></div>
      <div class="value-card"><div class="value-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></div><h3>Klient në Qendër</h3><p>Çdo gjë që bëjmë është e fokusuar në kënaqësinë dhe nevojat tuaja</p></div>
    </div>
    <div class="about-stats">
      <div class="stat-item"><div class="stat-number" data-target="50000">0</div><div class="stat-label">Klientë të Kënaqur</div></div>
      <div class="stat-item"><div class="stat-number" data-target="500">0</div><div class="stat-label">Mbps Shpejtësi</div></div>
    ...
    <div class="about-mission"><div class="mission-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg></div><h3>Misioni Ynë</h3><p>Të ofrojmë shërbimet më të mira telekomunikacionale me teknologji të avancuar, çmime konkurruese dhe shërbim të shkëlqyer. Ne jemi të përkushtuar të lidhim njerëzit, bizneset dhe komunitetet përmes infrastrukturës sonë moderne dhe inovative.</p></div>
  </div>
</div></section>
</main>
