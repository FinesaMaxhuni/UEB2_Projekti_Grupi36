...
<head>
  ...
  <title>Laptopë | NetWave E-Shop</title>
    ...
    <li class="nav-item-dropdown"><a href="#" class="nav-link">TV <span class="chevron"><svg viewBox="0 0 16 10"><path d="M2 3 L8 8 L14 3"/></svg></span></a><ul class="dropdown"><li><a href="tv-packages.html">Pakot TV</a></li><li><a href="tv+internet.html">Pakot TV + internet</a></li><li><a href="channels-list.html">Lista e kanaleve</a></li></ul></li>
            ...
            <li class="nav-item-dropdown">
              ...
              <ul class="dropdown">
                ...
                <li><a href="telfoniafikse.html">Telefonia Fikse</a></li>
              </ul>
            </li>
      ...
      <div class="container">
        ...
        <div class="product-grid">
          ...
          <div class="product-item">
            <img src="laptopa/dell_xps_13.jpg" alt="Dell XPS 13">
            <h3>Dell XPS 13</h3>
          ...
          <div class="product-item">
            <img src="laptopa/macbook_air.webp" alt="MacBook Air M2">
          ...
          <div class="product-item">
            <img src="laptopa/hp_spectre1.jpg" alt="HP Spectre x360">
          ...
          <div class="product-item">
            <img src="laptopa/lenovo_idepad.jpg" alt="Lenovo IdeaPad 5">
          ...
          <div class="product-item">
            <img src="laptopa/asus_zenbook.jpg" alt="ASUS ZenBook 14">
          ...
          <div class="product-item">
            <img src="laptopa/acer_swift.jpg" alt="Acer Swift 5">
            <h3>Acer Swift 5</h3>
          ...
          <div class="product-item">
            <img src="laptopa/msi_gs66_stealth.jpg" alt="MSI GS66 Stealth">
          ...
          <div class="product-item">
            <img src="laptopa/hp_pavilion.jpg" alt="HP Pavilion 15">
          ...
          <div class="product-item">
            <img src="laptopa/lenovo_idepad.jpg" alt="Lenovo ThinkPad X1 Carbon">
          ...
          <div class="product-item">
            <img src="laptopa/asus_tuf_gaming.jpg" alt="ASUS TUF Gaming F15">
          ...
          <div class="product-item">
            <img src="laptopa/dell_inspiron.jpg" alt="Dell Inspiron 14">
          ...
          <div class="product-item">
            <img src="laptopa/acer_nitro.jpg" alt="Acer Nitro 5">
            <h3>Acer Nitro 5</h3>
            <p class="product-price">999€</p>
            <a href="pagesa.html" class="btn btn-primary">Bleje tani</a>
          </div>
          ...
          <div class="product-item">
            <img src="laptopa/macbook_pro.jpeg" alt="MacBook Pro M3">
          ...
          <div class="product-item">
            <img src="laptopa/lenovo_legion7.avif" alt="Lenovo Legion 7">
          ...
          <div class="product-item">
            <img src="laptopa/asus_rog_zephyrus.jpg" alt="ASUS ROG Zephyrus G14">
